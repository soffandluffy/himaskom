...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'teal darken-1', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => 'teal darken-1', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'templateTitle' => 'HIMASKOM', //template Title can be changes default('Materialize)
        ...
        'largeScreenLogo' => 'images/himaskom/logohimaskom.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/himaskom/logohimaskom.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
